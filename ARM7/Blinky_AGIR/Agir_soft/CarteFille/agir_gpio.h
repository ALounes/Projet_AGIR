...
// DEFINITION des port et leurs pin pour les LED
	...
	#define PORT_BP_MARGEUR_00
	#define PIN_BP_MARGEUR_00
	...
	#define PORT_BP_MARGEUR_01
	#define PIN_BP_MARGEUR_01

	#define PORT_CAPTEUR_MARGEUR_01
	#define PIN_CAPTEUR_MARGEUR_01
	...
	#define PORT_BP_MARGEUR_02
	#define PIN_BP_MARGEUR_02

	#define PORT_CAPTEUR_MARGEUR_02
	#define PIN_CAPTEUR_MARGEUR_02
	...
	#define PORT_BP_MARGEUR_03
	#define PIN_BP_MARGEUR_03

	#define PORT_CAPTEUR_MARGEUR_03
	#define PIN_CAPTEUR_MARGEUR_03
	...
	#define PORT_BP_MARGEUR_04
	#define PIN_BP_MARGEUR_04

	#define PORT_CAPTEUR_MARGEUR_04
	#define PIN_CAPTEUR_MARGEUR_04
